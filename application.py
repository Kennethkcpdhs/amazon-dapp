...
@application.route("/competition_details")
@login_required
...
@application.route("/announcements")
@login_required
def announcements():
    connection = sqlite3.connect("sqlite_db")
    cursor = connection.cursor()
...
@application.route("/announcement_details")
@login_required
...
@application.route("/submit2", methods=["POST"])
@login_required
def submit2():
...
@application.route("/delete2", methods=["POST"])
@login_required
def delete2():
    group = request.form.get("group")
    connection = sqlite3.connect("sqlite_db")
...
@application.route("/deletion", methods=["POST"])
@login_required
def deletion():
...
if __name__ == '__main__':
    ...
    #for deployment to heroku application use this
